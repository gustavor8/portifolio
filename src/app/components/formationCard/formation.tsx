...
export default function Formation({
  ...
  return (
    <article className="h-[17rem] w-[13rem] p-[0.5rem] flex flex-row justify-center items-start rounded-[10px] shadow-md shadow-[#FF5733] bg-slate-400  dark:bg-slate-800 flex-wrap dark:text-white transition-colors duration-300 ease-in-out overflow-y-auto text-center">
